            ...
            <div className="space-y-4 sm:space-y-6 pt-4">
              {transactions.length > 0 ? (
                transactions.map((transaction: transaction, index: number) => (
                  <div className="flex flex-row items-start items-center justify-between " key={index}>
                    <div className="flex items-center space-x-3 w-full sm:w-auto">
                      ...
                      <div className="flex-grow sm:flex-grow-0">
                        <p className="text-sm font-medium text-gray-800 dark:text-gray-200">{transaction.purpose}</p>
                ...
                <p className="text-sm font-medium text-gray-800 dark:text-gray-200">No transactions found.</p>
              )}
            </div>
          </CardContent>
        </Card>
